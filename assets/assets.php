...
function titan_framework()
{
    ...
    wp_register_style('iconos', get_template_directory_uri() . '/assets/librerias/fafa/css/all.css', 'all');
    ...
    wp_register_style('base', get_template_directory_uri() . '/assets/librerias/css/base.css', 'all');
...
//modulo-botanico
include get_template_directory() . '/assets/modulos/modulo-botanico/core-botanico.php';
